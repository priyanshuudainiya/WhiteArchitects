...
export default function LandingPage() {
  return (
    <div className="relative w-full h-screen bg-[#121111] overflow-hidden">
      {/* Background architectural image */}
      <div
        className="absolute inset-0 opacity-10 bg-no-repeat bg-fit bg-center"
        style={{
          backgroundImage: "url('MAdrid, Spain.png')",
      ...
      <main className="flex items-center h-[80vh] gap-25">
        <div className="flex items-center">
          ...
          <div className="pl-20">
            <h1 className="text-5xl font-light leading-tight !text-[#BBBFC0]">
              Sharp & Beautiful
              <br />
              The Edge Building
            </h1>
            <p className="text-[#BBBFC0] mt-4">Madrid, Spain</p>
          </div>
        </div>
